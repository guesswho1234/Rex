myActionButton = function(id, deText, enText, icon, disabled = FALSE){
  tags$button(id = id, class = paste0("btn btn-default action-button shiny-bound-input", ifelse(disabled, " shinyjs-disabled", "")), type="button", myButtonStyle(deText, enText, icon))
}
