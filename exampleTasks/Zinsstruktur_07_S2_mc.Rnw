...
\begin{question}
        ...
        \\ \hline \ Spot Rate \  &
		\Sexpr{eform(i[1]*100, digits = prec)}\% & \Sexpr{eform(i[2]*100, digits = prec)}\% & \Sexpr{eform(i[3]*100, digits = prec)}\% & \Sexpr{eform(i[4]*100, digits = prec)}\% & \Sexpr{eform(i[5]*100, digits = prec)}\% & \Sexpr{eform(i[6]*100, digits = prec)}\% & \Sexpr{eform(i[7]*100, digits = prec)}\% & \Sexpr{eform(i[8]*100, digits = prec)}\% & \Sexpr{eform(i[9]*100, digits = prec)}\% & \Sexpr{eform(i[10]*100, digits = prec)}\%\\ \hline
		\end{tabular}
