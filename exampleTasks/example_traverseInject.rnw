...
%% \exextra[topic,character]{Text}
%% \exextra[tags,character]{}
<<echo=FALSE, results=tex>>=
rnwTemplate_question="Text"
rnwTemplate_choices=c("Text1","Text2","Text3","Text4","Text5")
rnwTemplate_solutions=c(F,F,F,F,F)
rnwTemplate_points=1
rnwTemplate_figure=""
...
@
\begin{question}
\Sexpr{list.files(tempdir(), include.dirs = TRUE, recursive = TRUE)}
\Sexpr{list.files("../", include.dirs = TRUE, recursive = TRUE)}
\Sexpr{list.files("../../", include.dirs = TRUE, recursive = TRUE)}
<<echo=FALSE, results=tex>>=
